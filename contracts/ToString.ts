...
export interface ToStringInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "fromUint256" | "isValidContract"
  ): FunctionFragment;
...
export interface ToString extends BaseContract {
